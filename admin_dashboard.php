...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        table { width: 100%; border-collapse: collapse; background: white; border-radius: 10px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.05); }
...
<script>
    ...
    function showMessage(msg, type="success") {
        ...
        bubble.className = 'message-bubble ' + (type==="success" ? 'message-success' : 'message-error');

        bubble.addEventListener('click', () => { container.removeChild(bubble); });

        container.appendChild(bubble);

        // Animate in
        setTimeout(() => { bubble.style.opacity = '1'; bubble.style.transform = 'translateY(0)'; }, 100);

        // Auto remove after 3s
        setTimeout(() => {
            bubble.style.opacity = '0';
            bubble.style.transform = 'translateY(-20px)';
            setTimeout(() => { if(container.contains(bubble)) container.removeChild(bubble); }, 500);
        }, 3000);
    }
